...
#' 
#' Provides the isotropic fixed bandwidth for a 2D point pattern based on the
...
#' estimates of 2-dimensional data: the ``maximal amount of smoothing
#' compatible with the estimated scale of the observed data''. See Terrell
#' (1990). \describe{ \item{list("Effective sample size")}{ The formula
...
#' \code{pp}: \code{nstar = "npoints"}. If \code{pp} is a
...
#' \bold{29}(23) 2423-2437.\cr\cr Terrell, G.R. (1990), The maximal smoothing
