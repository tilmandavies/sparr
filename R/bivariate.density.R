...
#' shown above) are also implemented. \describe{ \item{list("Fixed")}{The
#' classic fixed bandwidth kernel estimator is used when \code{adapt = FALSE}.
#' This amounts to setting \eqn{h(u)=}\code{h0} for all \eqn{u}. Further
#' details can be found in the documentation for
#' \code{\link[spatstat]{density.ppp}}.} \item{list("Adaptive")}{Setting
#' \code{adapt = TRUE} requests computation of Abramson's (1982)
...
#' computed using the pilot bandwidth \code{hp}. \itemize{ \itemGlobal
#' smoothing of the variable bandwidths is controlled with the global bandwidth
#' \code{h0}. \itemIn the above statement, \eqn{G} is the geometric mean of the
...
#' \code{gamma.scale = 1}. \itemThe variable bandwidths must be trimmed to
...
#' no trimming, set \code{trim = Inf}. \itemFor even moderately sized data sets
...
#' coarsening). \itemComputation of leave-one-out values (when
