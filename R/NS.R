...
#' (1986) or Wand and Jones (1995). \describe{ \item{list("Effective sample
#' size")}{ The formula requires a sample size, and this can be minimally
...
#' \item{list("Spatial scale")}{ For isotropic smoothing, we require a scalar
...
#' \bold{29}(23) 2423-2437.\cr\cr Davies, T.M., Flynn, C.R. and Hazelton, M.L.
#' (2017), On the utility of asymptotic bandwidth selectors for spatially
#' adaptive kernel density estimation, \emph{Submitted}.\cr\cr Silverman, B.W.
#' (1986), \emph{Density Estimation for Statistics and Data Analysis}, Chapman
#' & Hall, New York. \cr\cr Wand, M.P. and Jones, C.M., 1995. \emph{Kernel
